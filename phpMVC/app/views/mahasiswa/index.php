...
<br>
            ...
            <li class="list-group-item ">
                ...
                <a href="<?= BASEURL; ?>/mahasiswa/ubah/<?= $mhs['id'];?>class="badge badge-success float-right ml-1 tampilModalUbah" data-toggle="modal" data-target="#formModal" data-i="<?= $mhs['id'];?>">ubah</a>
